# AnySite MCP Server
[![smithery badge](https://smithery.ai/badge/@anysiteio/mcp)](https://smithery.ai/server/@anysiteio/mcp)
...
To install AnySite MCP Server for Claude Desktop automatically via [Smithery](https://smithery.ai/server/@anysiteio/mcp):

```bash
npx -y @smithery/cli install @anysiteio/mcp --client claude
```
