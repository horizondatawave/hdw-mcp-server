...
import { ListResourcesRequestSchema, ListToolsRequestSchema, CallToolRequestSchema, ErrorCode, McpError } from "@modelcontextprotocol/sdk/types.js";
import dotenv from "dotenv";
import { isValidLinkedinSearchUsersArgs, isValidLinkedinUserProfileArgs, isValidLinkedinEmailUserArgs, isValidLinkedinUserPostsArgs, isValidLinkedinUserReactionsArgs, isValidLinkedinUserCommentsArgs, isValidLinkedinChatMessagesArgs, isValidSendLinkedinChatMessageArgs, isValidSendLinkedinConnectionArgs, isValidSendLinkedinPostCommentArgs, isValidGetLinkedinUserConnectionsArgs, isValidGetLinkedinPostRepostsArgs, isValidGetLinkedinPostCommentsArgs, isValidGetLinkedinPostReactionsArgs, isValidGetLinkedinGoogleCompanyArgs, isValidGetLinkedinCompanyArgs, isValidGetLinkedinCompanyEmployeesArgs, isValidSendLinkedinPostArgs, isValidLinkedinSalesNavigatorSearchUsersArgs, isValidLinkedinManagementConversationsArgs, isValidGoogleSearchPayload, isValidLinkedinSearchPostsArgs, isValidRedditSearchPostsArgs, isValidInstagramUserArgs, isValidInstagramUserPostsArgs, isValidInstagramPostCommentsArgs, isValidLinkedinCompanyPostsArgs } from "./types.js";
...
function isValidUserURN(urn) {
    return urn.startsWith("fsd_profile:");
}
const SEARCH_LINKEDIN_USERS_TOOL = {
...
const GET_LINKEDIN_PROFILE_TOOL = {
...
const GET_LINKEDIN_USER_POSTS_TOOL = {
...
const GET_LINKEDIN_USER_REACTIONS_TOOL = {
...
const GET_LINKEDIN_USER_COMMENTS_TOOL = {
...
const SEND_CONNECTION_REQUEST_TOOL = {
...
const GET_USER_CONNECTIONS_TOOL = {
...
const GET_LINKEDIN_POST_REPOSTS_TOOL = {
...
const GET_LINKEDIN_POST_COMMENTS_TOOL = {
...
const GET_LINKEDIN_POST_REACTIONS_TOOL = {
...
const GET_LINKEDIN_GOOGLE_COMPANY_TOOL = {
...
const GET_LINKEDIN_COMPANY_TOOL = {
...
const GET_LINKEDIN_COMPANY_EMPLOYEES_TOOL = {
...
const LINKEDIN_SN_SEARCH_USERS_TOOL = {
...
const GET_LINKEDIN_CONVERSATIONS_TOOL = {
...
const LINKEDIN_SEARCH_POSTS_TOOL = {
...
const REDDIT_SEARCH_POSTS_TOOL = {
...
const INSTAGRAM_USER_POSTS_TOOL = {
...
const INSTAGRAM_POST_COMMENTS_TOOL = {
...
const GET_LINKEDIN_COMPANY_POSTS_TOOL = {
...
const server = new Server({ name: "anysite-mcp", version: "0.1.0" }, {
    capabilities: {
    ...
    try {
        ...
        switch (name) {
            case "search_linkedin_users": {
                ...
                const { keywords, first_name, last_name, title, company_keywords, school_keywords, current_company, past_company, location, industry, education, count = 10, timeout = 300 } = args;
                const requestData = { timeout, count };
                if (keywords)
                ...
                if (company_keywords)
                    requestData.company_keywords = company_keywords;
                if (school_keywords)
                    requestData.school_keywords = school_keywords;
                if (current_company) {
            ...
            case "get_linkedin_profile": {
                ...
                const { user, with_experience = true, with_education = true, with_skills = true } = args;
            ...
            case "get_linkedin_email_user": {
                ...
                const { email, count = 5, timeout = 300 } = args;
            ...
            case "get_linkedin_user_posts": {
                ...
                const { urn, count = 10, timeout = 300 } = args;
            ...
            case "get_linkedin_user_comments": {
                ...
                const { urn, count = 10, timeout = 300, commented_after } = args;
                const normalizedURN = normalizeUserURN(urn);
                if (!isValidUserURN(normalizedURN)) {
                    throw new McpError(ErrorCode.InvalidParams, "Invalid URN format. Must start with 'fsd_profile:'");
                }
            ...
            case "get_linkedin_chat_messages": {
                ...
                const { user, company, count = 20, timeout = 300 } = args;
            ...
            case "send_linkedin_chat_message": {
                ...
                const { user, company, text, timeout = 300 } = args;
                const normalizedUser = normalizeUserURN(user);
                if (!isValidUserURN(normalizedUser)) {
                    throw new McpError(ErrorCode.InvalidParams, "Invalid URN format. Must start with 'fsd_profile:'");
                }
            ...
            case "send_linkedin_post_comment": {
                ...
                const { text, urn, timeout = 300 } = args;
            ...
            case "send_linkedin_post": {
                ...
                const { text, visibility = "ANYONE", comment_scope = "ALL", timeout = 300 } = args;
                const requestData = {
                    text,
                    visibility,
                    comment_scope,
            ...
            case "get_linkedin_user_connections": {
                ...
                const { connected_after, count = 20, timeout = 300 } = args;
                const requestData = {
            ...
            case "get_linkedin_post_comments": {
                ...
                const { urn, sort = "relevance", count = 10, timeout = 300 } = args;
                const requestData = {
                    timeout: Number(timeout),
                    urn,
                    sort,
            ...
            case "get_linkedin_post_reactions": {
                ...
                const { urn, count = 50, timeout = 300 } = args;
                const requestData = {
                    timeout: Number(timeout),
                    urn,
                    count: Number(count)
            ...
            case "get_linkedin_google_company": {
                ...
                const { keywords, with_urn = false, count_per_keyword = 1, timeout = 300 } = args;
                const requestData = {
                    timeout: Number(timeout),
                    keywords,
            ...
            case "get_linkedin_company": {
                ...
                const { company, timeout = 300 } = args;
                const requestData = {
                    timeout: Number(timeout),
                    company
                };
            ...
            case "get_linkedin_company_employees": {
                ...
                const { companies, keywords, first_name, last_name, count = 10, timeout = 300 } = args;
                const requestData = {
                    timeout: Number(timeout),
                    companies,
                    count: Number(count)
            ...
            case "linkedin_sn_search_users": {
                ...
                const { keywords, first_names, last_names, current_titles, location, education, languages, past_titles, functions, levels, years_in_the_current_company, years_in_the_current_position, company_sizes, company_types, company_locations, current_companies, past_companies, industry, count, timeout = 300 } = args;
                const requestData = {
                    count,
                    timeout
                };
                if (keywords)
                    requestData.keywords = keywords;
                if (first_names)
                    requestData.first_names = first_names;
                if (last_names)
                    requestData.last_names = last_names;
                if (current_titles)
                    requestData.current_titles = current_titles;
                if (location) {
                ...
                if (past_titles)
                    requestData.past_titles = past_titles;
                if (functions)
                    requestData.functions = functions;
                if (levels)
                    requestData.levels = levels;
                if (years_in_the_current_company)
                    requestData.years_in_the_current_company = years_in_the_current_company;
                if (years_in_the_current_position)
                    requestData.years_in_the_current_position = years_in_the_current_position;
                if (company_sizes)
                    requestData.company_sizes = company_sizes;
                if (company_types)
                    requestData.company_types = company_types;
            ...
            case "google_search": {
                ...
                const { query, count = 10, timeout = 300 } = args;
                const requestData = {
                    timeout,
                    query,
            ...
            case "search_linkedin_posts": {
                ...
                const { timeout = 300, keywords = "", sort = "relevance", date_posted = "past-month", content_type, mentioned, authors, author_industries, author_title, count } = args;
                const requestData = { timeout, count };
                if (keywords)
                    requestData.keywords = keywords;
                if (sort)
                ...
                if (date_posted)
                    requestData.date_posted = date_posted;
                if (content_type)
                    requestData.content_type = content_type;
                if (mentioned)
                    requestData.mentioned = mentioned;
                if (authors)
                    requestData.authors = authors;
                if (author_industries)
                    requestData.author_industries = author_industries;
                if (author_title)
                    requestData.author_title = author_title;
            ...
            case "search_reddit_posts": {
                ...
                const { timeout = 300, query, sort = "relevance", time_filter = "all", count } = args;
                const requestData = {
                    timeout,
                    query,
                    sort,
            ...
            case "get_instagram_user_posts": {
                ...
                const { timeout = 300, user, count } = args;
                const requestData = {
                    timeout,
                    user,
                    count
            ...
            case "get_instagram_post_comments": {
                ...
                const { timeout = 300, post, count } = args;
                const requestData = {
                    timeout,
                    post,
                    count
